...
GPIO.output(ledPinRed, GPIO.HIGH) # setting the gpio pin to high (a.k.a will turn off all leds initally)
GPIO.output(ledPinGreen, GPIO.HIGH) # setting the gpio pin to high (a.k.a will turn off all leds initally)
